#!/bin/bash
# Train 6 models on Lake Huron1 using the current dataset layout.
set -e
...
run_one() {
    ...
    local model_id="local_train_${model_short}_huron1"
    echo ""
    echo "===== TRAINING: ${model_class} @ huron1 ====="
