#!/bin/bash
# Train 6 models on Lake Huron3 using the current dataset layout.
set -e
...
DATA_PATH="huron3.csv"
ENC_IN=15
DES="realtrain_huron3"
...
run_one() {
    ...
    local model_id="local_train_${model_short}_huron3"
    echo ""
    echo "===== TRAINING: ${model_class} @ huron3 ====="
