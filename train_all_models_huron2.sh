#!/bin/bash
# Train 6 models on Lake Huron2 using the current dataset layout.
set -e
...
DATA_PATH="huron2.csv"
ENC_IN=15
DES="realtrain_huron2"
TARGET="chl_btm__Chlorophyll"
...
run_one() {
    ...
    local model_id="local_train_${model_short}_huron2"
    echo ""
    echo "===== TRAINING: ${model_class} @ huron2 ====="
